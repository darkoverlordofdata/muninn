...
class muninn.db.Driver
  ...
  query_times: null
  #
  # @property [muninn.core.Controller] The page controller
  #
  controller: null
  #
  ...
  # @param  [muninn.core.Controller]  controller  the page controller
  #
...
#    $iterate()
  ...
  _cache_init: ->
    ...
    Object.defineProperties @,
      _cache    : {writeable: false, enumerable: true, value: new muninn.db.Cache(@, @controller.uri)}
    return true
...
module.exports = muninn.db.Driver
