...
class muninn
  ...
  #
  @loadClass = ($class, $folder = 'core', $prefix = '') ->
  ...
  #
  # DB namespace - Everything loaded via @load.database goes here
  #
  class @db

  #
  # Lib namespace - Everything loaded via @load.xxxx goes here
  #
  class @lib
